...
export const metadata: Metadata = {
  ...
  description: '終末期・難病・医療依存度の高い方の住まいをお探しなら、シーズメディカルホームへ。24時間看護体制・看取り対応・訪問診療連携。横浜市保土ヶ谷区・藤沢市・川崎市に展開する医療特化型介護施設。入居相談受付中。',
  keywords: [
  ...
  openGraph: {
    ...
    description: '終末期・難病・医療依存度の高い方の住まいをお探しなら。24時間看護・看取り対応・訪問診療連携。横浜市保土ヶ谷区・藤沢市・川崎市に展開する医療特化型介護施設。',
    images: [
      {
