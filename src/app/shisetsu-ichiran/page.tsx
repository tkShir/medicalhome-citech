...
export const metadata = {
  title: '施設一覧',
  description: 'シーズメディカルホームの施設一覧。横浜市保土ヶ谷区・藤沢市・川崎市・日野市に医療特化型介護施設を展開。終末期・難病・神経難病（ALS・パーキンソン病など）・医療依存度の高い方の入居をサポートします。',
  openGraph: {
    type: 'website',
    ...
    description: '横浜市保土ヶ谷区・藤沢市・川崎市・日野市に展開する医療特化型介護施設の一覧。終末期・難病・神経難病（ALS・パーキンソン病など）・医療依存度の高い方の24時間看護体制・看取り対応。入居受付中。',
  },
}
