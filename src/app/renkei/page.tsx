...
export const metadata: Metadata = {
  title: '医療機関・ご紹介の方へ',
  description: '退院支援・地域連携室のご担当者様へ。胃ろう・気管切開・人工呼吸器など高医療依存の方の退院後施設をお探しでしたら、シーズメディカルホームへ。別表第7・第8対応。横浜市保土ヶ谷区・藤沢市・川崎市。',
  openGraph: {
    type: 'website',
    ...
    description: '退院支援・地域連携室のご担当者様へ。胃ろう・気管切開・人工呼吸器（IPPV/NPPV）・CV管理など高医療依存の方の受け入れ可能。別表第7・第8対応。横浜市保土ヶ谷区・藤沢市・川崎市。',
  },
}
