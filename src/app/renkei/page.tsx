...
export const metadata: Metadata = {
  title: '医療機関・ご紹介の方へ',
  description: '退院支援・地域連携室のご担当者様へ。難病・神経難病（ALS・パーキンソン病など）・胃ろう・気管切開・人工呼吸器など高医療依存の方の退院後施設をお探しでしたら、シーズメディカルホームへ。別表7・8の方にも対応しております。横浜市保土ヶ谷区・藤沢市（オープン予定）・川崎市（オープン予定）。',
  openGraph: {
    type: 'website',
    url: 'https://medicalhome.citech.co.jp/renkei',
    locale: 'ja_JP',
    siteName: 'シーズメディカルホーム',
    title: '医療機関・ご紹介の方へ | シーズメディカルホーム',
    description: '退院支援・地域連携室のご担当者様へ。難病・神経難病（ALS・パーキンソン病など）・胃ろう・気管切開・人工呼吸器（IPPV/NPPV）対応。別表7・8の方にも対応しております。横浜市保土ヶ谷区・藤沢市（オープン予定）・川崎市（オープン予定）。',
  },
}
...
const medicalSupport = [
  {
    title: '24時間看護体制',
    desc: '看護師が24時間体制で入居者様の状態を管理します。夜間の急変時にも迅速に対応できる体制を整えています。',
  },
  {
    title: '訪問診療連携',
...
const steps = [
  ...
  },
  {
    num: '02',
    title: '情報共有・アセスメント',
    desc: '看護サマリーや診療情報等をご共有いただき、お受け入れ態勢について検討してまいります。必要に応じて施設見学・病院訪問面談もご案内します。',
  },
  {
    num: '03',
    title: '入居申込・契約',
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div>
                ...
                <div className="space-y-4 font-sans text-sm text-darkgray leading-[1.9]">
                  ...
                  <p>
                    現在、神奈川県横浜市・藤沢市・川崎市に拠点があります（一部開設予定）。
                  </p>
                  <p>
